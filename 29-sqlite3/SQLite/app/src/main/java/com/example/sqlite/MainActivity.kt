...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var sqliteHelper: SQL_Helper
    ...
    private fun getStudents(){
        ...
        Log.e("# in database","${stdList.size}")

        //DISPLAY DARA IN RECYCLER VIEW
